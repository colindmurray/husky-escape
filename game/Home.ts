...
export const FAMILY = [
    { id: 'maria', name: 'Maria', room: 'bedroom', x: 720, greeting: 'Oh hi Onyx! Wanna read with me? I saved you a spot on the blanket. This chapter has a dragon who is afraid of kittens.', detail: 'Maria turns a page quietly. Ruby is curled into a little doughnut, with her nose nestled into her fluffy tail and a tiny pink blep.', lines: ['A good reading nook needs three things: a book, a blanket, and a very sleepy Ruby.', 'Ruby dreams through all the exciting bits. Even dragons cannot wake her up.', 'You can borrow my little book satchel. Every adventure needs a story.'] },
