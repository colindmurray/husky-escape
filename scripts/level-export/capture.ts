// Local Vite entry for the export CLI. Nothing in the game imports this module.
import { World } from '../../game/engine/World';
import { Renderer } from '../../game/engine/Renderer';
import { audioManager } from '../../game/Audio';
import { gfxSettings } from '../../game/GfxSettings';
import { BossRaccoon } from '../../game/entities/Backyard';
import { HOME_WIDTH, QUESTS } from '../../game/Home';
import { isLevelDraft, validateLevel } from '../../game/LevelBuilder';
...
export function prepare(options: CaptureOptions) {
    ...
    audioManager.setMusic(false); audioManager.setSFX(false); gfxSettings.setVisualMode(options.graphics);
...
Object.assign(window, { levelExport: { prepare, capture } });
